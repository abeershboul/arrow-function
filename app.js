...
const newObjectLit = () => ({ key1: 'value1', key2: 'value2', key3: 'value3' })
...
/*  function does consider and redefines everything in it to the place it was called in/for
   Student.prototype.scope = function() {
   console.log(this);
   };
   joe.scope();
    the function scope is being called by joe, so, it redefiens (this) to be related to joe and this action is called (based on context).
   ...
   Student.prototype.scopeArrow = () => console.log(this);
   joe.scopeArrow();
   in the aforementioned exmaple, (this) refers to  the window in the browser,
